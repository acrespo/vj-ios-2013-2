...
{
    return [(CTCAppDelegate*)[UIApplication sharedApplication].delegate client];
}
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.client = [[AFHTTPClient alloc] initWithBaseURL:[NSURL URLWithString:@"http://10.6.0.247:9000"]];
